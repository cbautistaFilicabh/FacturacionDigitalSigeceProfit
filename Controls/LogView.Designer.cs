namespace FacturacionDigital_SIGECE.Controls
{
    partial class LogView
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnOk.BackColor1 = Color.FromArgb(51, 122, 183);
            btnOk.BackgroundImage = (Image)resources.GetObject("btnOk.BackgroundImage");
            btnOk.BorderStyle = Bunifu.UI.WinForms.BunifuButton.BunifuButton2.BorderStyles.Solid;
            btnOk.ButtonText = "Aceptar";
            ...
            btnOk.CustomizableEdges = borderEdges1;
            btnOk.DialogResult = DialogResult.None;
            btnOk.DisabledBorderColor = Color.FromArgb(191, 191, 191);
            btnOk.DisabledFillColor = Color.Empty;
            btnOk.DisabledForecolor = Color.Empty;
            ...
            btnOk.IconLeftPadding = new Padding(11, 3, 3, 3);
            btnOk.IconMarginLeft = 11;
            btnOk.IconPadding = 10;
            btnOk.IconRight = null;
            btnOk.IconRightAlign = ContentAlignment.MiddleRight;
            btnOk.IconRightCursor = Cursors.Default;
            btnOk.IconRightPadding = new Padding(3, 3, 7, 3);
            btnOk.IconSize = 25;
            btnOk.IdleBorderColor = Color.Empty;
            btnOk.IdleBorderRadius = 0;
            btnOk.IdleBorderThickness = 0;
            btnOk.IdleFillColor = Color.Empty;
            ...
            btnOk.Size = new Size(380, 37);
            btnOk.TabIndex = 1;
            btnOk.TextAlign = ContentAlignment.MiddleCenter;
            btnOk.TextAlignment = HorizontalAlignment.Center;
            btnOk.TextMarginLeft = 0;
            btnOk.TextPadding = new Padding(0);
